...
<head>
    ...
    <title>Connexion | WedDream</title>
    ...
    <style>
        :root {
            ...
            --text-muted: #555555;
            --brand-dark: #2c3e50;
            --bg-solid-light: #f8f9fa; /* Fond uni épuré */
        }
        ...
        /* SECTION GAUCHE : IDENTITÉ VISUELLE IMMERSIVE (CONSERVÉE) */
        .brand-section {
        ...
        /* SECTION DROITE : FORMULAIRE SUR FOND UNI SUR MESURE */
        .form-section {
            background-color: var(--bg-solid-light); /* Application du fond uni */
            display: flex;
            align-items: center;
            justify-content: center;
            padding: 60px 40px;
        ...
        /* Boîte de connexion blanche au contraste parfait */
        .form-card-white {
            width: 100%;
            max-width: 430px;
            background: #ffffff;
        ...
        @media (max-width: 991.98px) {
            ...
            .form-card-white {
                ...
                box-shadow: none;
                border: none;
                background: transparent; /* Se fond dans l'écran sur mobile */
            }
        }
    </style>
</head>
...
<div class="container-fluid p-0">
    <div class="row g-0 login-container">
        ...
        <!-- COLONNE GAUCHE : IDENTITÉ VISUELLE IMMERSIVE -->
        ...
        <!-- COLONNE DROITE : FORMULAIRE SUR FOND UNI -->
        <div class="col-lg-6 form-section">
            <div class="form-card-white">
                
                <div class="mb-4">
                    <h2 class="form-header-title">Espace Privé</h2>
                    <p class="text-muted small">Renseignez vos identifiants pour vous connecter.</p>
                </div>
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" class="form-control" 
                                   placeholder="nom@exemple.com" required value="{{ old('email') }}">
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <a href="{{ route('password.request') }}" class="text-decoration-none forgot-link">Mot de passe oublié ?</a>
                    </div>
                </form>
